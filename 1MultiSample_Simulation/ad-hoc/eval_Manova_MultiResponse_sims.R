...
saveRDS(res, file = paste0("res/1MultiSample_MultiResponse_Simulation/Manova_sims_nSample20_", name,".rds"))
...
dat <- readRDS("res/1MultiSample_MultiResponse_Simulation/Manova_sims_nSample20_Pooled_Content_Sample_Prevalence_Time.rds")
...
topic_plot <- topic_plot %>%
  ...
  rename(Time = time_sig_proportion,
