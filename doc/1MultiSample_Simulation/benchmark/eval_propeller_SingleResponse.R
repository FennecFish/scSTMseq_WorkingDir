...
################################# ARI #########################################
#################################################################################
ari_file <- list.files("res/1MultiSample_SingleResponse_Simulation/seurat_ARI")
dat <- data.frame()
...
#   cat(file_name, "\n")
# }
# saveRDS(res, file = paste0("res/1MultiSample_SingleResponse_Simulation/Propeller_limma_",basename(dir), "_AltHypothesis.rds"))
# 
# #################################################################################
# ################################# Power #########################################
# #################################################################################
