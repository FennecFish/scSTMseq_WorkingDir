...
scSTM.mod <- selectModel(dat$documents, dat$vocab, K = ngroup,
                         prevalence=~time, content=~Batch, data=dat$meta,
                         max.em.its=100, verbose=TRUE, init.type = "Random",
                         emtol= 1e-05, seed=NULL,runs=20, N = 5)
...
saveRDS(scSTM.mod, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/fig1/", 
                           "STM_allGenes_Content_", set_level, ".rds"))
